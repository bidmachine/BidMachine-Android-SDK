...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.7.4.9-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.adcolony/1.7.4.9/)
...
dependencies {
    implementation 'io.bidmachine:ads.networks.adcolony:1.7.4.9'
}
```
