...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.4.0.2-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.adcolony/1.4.0.2/)
...
dependencies {
    // ... other dependencies
    implementation 'io.bidmachine:ads.networks.adcolony:1.4.0.2'
}
```
