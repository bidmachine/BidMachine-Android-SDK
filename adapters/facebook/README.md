...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.7.1.6-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.facebook/1.7.1.6/)
...
dependencies {
    // ... other dependencies
    implementation 'io.bidmachine:ads.networks.facebook:1.7.1.6'
}
```
