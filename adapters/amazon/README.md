...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.7.6.5-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.amazon/1.7.6.5/)
...
```groovy
dependencies {
    implementation 'io.bidmachine:ads.networks.amazon:1.7.6.5'
}
```
