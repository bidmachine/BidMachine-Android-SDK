...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.4.4.2-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.amazon/1.4.4.2/)
[<img src="https://img.shields.io/badge/Network%20version-8.3.0-blue">](https://ams.amazon.com/webpublisher/uam/docs/mobile-integration-documentation/other-ad-server-integration.html)
...
dependencies {
    // ... other dependencies
    implementation 'io.bidmachine:ads.networks.amazon:1.4.4.2'
}
```
