...
[<img src="https://img.shields.io/badge/Network%20Adapter%20version-1.6.0.3-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads.networks.my_target/1.6.0.3/)
[<img src="https://img.shields.io/badge/Network%20version-5.11.0-blue">](https://github.com/myTargetSDK/mytarget-android)
...
dependencies {
    // ... other dependencies
    implementation 'io.bidmachine:ads.networks.my_target:1.6.0.3'
}
```
