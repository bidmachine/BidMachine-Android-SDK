...
## Integration
[<img src="https://img.shields.io/badge/SDK%20version-1.7.6-brightgreen">](https://artifactory.bidmachine.io/bidmachine/io/bidmachine/ads/)
...
```groovy
dependencies {
    implementation 'io.bidmachine:ads:1.7.6'
}
```
